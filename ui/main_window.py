"""Main window UI for Glidly Pro AI Automator."""
import os
import json
import threading
import wx
from ui.variables import SimpleVar
from ui.dialogs import messagebox, filedialog
...
class MainWindow(wx.Frame):
    ...
    def setup_ui(self):
        ...
        # Sound Relief Options
        self._setup_sound_relief_options()
        
        # Video Generator Subcategory
        self._setup_subcategory_selection()
        
        # Configurations
        self._setup_configurations()
        
        # Google Flow Credentials
        self._setup_google_flow_credentials()
